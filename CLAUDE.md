...
- `src/features/<feature>/` screens + feature logic: landing, auth, onboarding, world-map, district, lesson, game, session, progress (server progress hook), admin
...
- `src/content/` districts, topics (practice + checkpoint game slugs, must match backend seed), lessons
